#version 150
//Rotating Crystals by HerobaneNair
...
void main() {
	...
	float check_inventory = float(ProjMat[2][3] == 0.0); // is the crystal in a GUI?
	float check_inventory_hand = 1.; // is this crystal in the player's hand in the GUI?
	...
	mat4 wm = ModelViewMat * (1.0 - min(1.0, check_inventory + check_hand)) // use world matrix unless...
	...
	float model_scale = 0.125 // base scale
					  ...
					  + 0.60 * check_inventory // even larger if in inventory
